<div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-2"><a href="3" class="text-white">Sitemaps</a></div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-2">
                            <a href="" class="text-white">
                                <i class="fa fa-phone"></i> +880 888-XXX-XXXX
                            </a>
                        </div>
                        <div class="mb-2">
                            <a href="" class="text-white">
                                <i class="fa fa-envelope"></i> yeayea@gmail.com
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="copyright-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <p class=""> &copy; 2023 - Kapore Dokan . All rights reserved.</p>
                    </div>
                    <div class="col-md-4">
